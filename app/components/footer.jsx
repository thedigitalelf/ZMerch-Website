  ...
  return (
    <>
      ...
      <footer>
        ...
        <p>gif sources: <a href="https://github.com/thedigitalelf/ZMerch-Website/blob/main/public/img/assets.md" target="_blank" style={{color: "#0099FF"}}>Internet Archive</a></p>
